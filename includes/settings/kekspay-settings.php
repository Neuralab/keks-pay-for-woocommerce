...
return apply_filters(
  ...
  array(
    ...
    'auth-token'       => array(
      'title'       => __( 'Sigurnosni ključ', 'kekspay' ),
      'type'        => 'title',
    ...
    'webshop-cid'      => array(
      'title'       => __( 'CID Web trgovine', 'kekspay' ),
      'type'        => 'text',
    ...
    'webshop-tid'      => array(
      'title'       => __( 'TID Web trgovine', 'kekspay' ),
      'type'        => 'text',
    ...
    'test-webshop-cid' => array(
      'title'       => __( 'TEST CID Web trgovine', 'kekspay' ),
      'type'        => 'text',
    ...
    'test-webshop-tid' => array(
      'title'       => __( 'TEST TID Web trgovine', 'kekspay' ),
      'type'        => 'text',
      'description' => __( 'Jedinstven testni identifikator Web trgovine unutar KEKS Pay sustava. Bit će dodijeljen od strane KEKS Pay sustava.', 'kekspay' ),
      'default'     => '',
      'desc_tip'    => true,
